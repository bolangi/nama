...
nama_command('Master; send 5;gen');
...
nama_command('Master; stereo'); # normal output width
...
nama_command('mixoff; master_off');
nama_command('for 4 5 6 7 8; remove_track quiet');
nama_command('Master; send 1');
nama_command('add_bus Horns; sax move_to_bus Horns; sax stereo');
...
nama_command('remove_bus Horns');
nama_command('add_submix_cooked Vo 5');
$expected_setup_lines = <<EXPECTED;
...
nama_command('remove_bus Vo');
nama_command('sax mono');
...
nama_command("add_tracks mic guitar; for 3 4; mon;; 4 source 2; stereo; add_submix_raw raw-user 7"); 
$expected_setup_lines = <<EXPECTED;
...
nama_command("add sax; mon; gen");
nama_command("add_insert post jconvolver; gen");
$expected_setup_lines = <<EXPECTED;
...
nama_command("add sax; mon; add_insert pre jconvolver; gen");
$expected_setup_lines = <<EXPECTED;
...
nama_command("add sax; mon; source 2; add_insert post 5; gen");
$expected_setup_lines = <<EXPECTED;
-a:1 -i:loop,Master_in
-a:3 -i:jack_multi,system:capture_2
...
nama_command("add sax; mon; source 2; add_insert pre 5; gen");
$expected_setup_lines = <<EXPECTED;
...
sub gen_alsa { force_alsa(); nama_command('gen')}
sub gen_jack { force_jack(); nama_command('gen')}
